...
public class MyJobService extends JobService {
    ...
    public static void startJob(Context context) {
        ...
        @SuppressLint("MissingPermission") JobInfo.Builder builder = new JobInfo.Builder(10,
                new ComponentName(context.getPackageName(),MyJobService.class.getName())).setPersisted(true);
