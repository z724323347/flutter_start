...
class BarChartPage1 extends StatefulWidget {
  @override
  _BarChartPage1State createState() => _BarChartPage1State();
}

class _BarChartPage1State extends State<BarChartPage1> {
  ...
  BarChartGroupData makeGroupData(int x, double y1, double y2) {
    return BarChartGroupData(barsSpace: 4, x: x, barRods: [
      BarChartRodData(
          ...
          width: width,
          isRound: true,
          backDrawRodData: BackgroundBarChartRodData(color: Colors.lightGreen)),
      BarChartRodData(
        y: y2,
        color: rightBarColor,
        width: width,
