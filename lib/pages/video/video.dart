...
import 'package:flutter_pro/pages/video/video_controller_bar.dart';
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          IconButton(
            ...
            onPressed: () async {
              String playUrl =
                  'http://s3.bytecdn.cn/aweme/resource/web/static/image/index/new-tvc_889b57b.mp4';
              // setState(() {
              ...
              // 重新设置播放地址
              controller.setNetworkDataSource(playUrl, autoPlay: false);
            },
          ),
        ],
      ),
            ...
            child: Container(
              ...
              child: IjkPlayer(
                ...
                controllerWidgetBuilder: (controller) {
                  // return _buildPlayBar(controller);
                  return TopControllerWidget(controller:controller);
                },
              ),
            ),
          ),
...
//              "https://www.sample-videos.com/video123/mp4/720/big_buck_bunny_720p_1mb.mp4",
    ...
    // });
    String playUrl = 'http://ivi.bupt.edu.cn/hls/cctv5phd.m3u8';

    await controller.setNetworkDataSource(playUrl, autoPlay: false //自动播放
        );
  ...
  Widget _buildPlayBar(IjkMediaController controller) {
    return Container(
      child: Stack(
        children: <Widget>[
          Positioned(
            ...
            child: Container(
              ...
              height: MediaQuery.of(context).size.width / 160 * 12,
                        ...
                        InkWell(
                          ...
                          child: Row(
                            children: <Widget>[
                              Icon(
                                Icons.live_tv,
                                color: Color(0xFFE2BA7C),
                                size: 20,
                              ),
                              Text('   直播',
                                  style: TextStyle(color: Color(0xFFE2BA7C)))
                            ],
                          ),
                        ),
                        SizedBox(
