...
part 'video_full_screen.part.dart';
...
class TopControllerWidget extends StatefulWidget {
  ...
  @override
  _TopControllerWidgetState createState() => _TopControllerWidgetState();

  TopControllerWidget copyWith({
    Key key,
...
class _TopControllerWidgetState extends State<TopControllerWidget>
...
class PortraitController extends StatelessWidget {
  ...
  Widget buildTopBar(BuildContext context) {
    var closeButton = buildCloseButton(context);
                ...
                InkWell(
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      Text('   直播', style: TextStyle(color: Color(0xFFE2BA7C)))
                    ],
                  ),
                ),
                SizedBox(
                ...
                InkWell(
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      Text('   动画', style: TextStyle(color: Color(0xFF949494)))
                    ],
                  ),
                )
              ],
