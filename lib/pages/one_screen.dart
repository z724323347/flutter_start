          ...
          children: <Widget>[
            ...
            RaisedButton(
              ...
              onPressed: () {
                ...
                Navigator.of(context).push(
                  CustomRoute(
                      WebViewDemo('webview title', 'http://www.baidu.com/')),
                );
              },
            ),
            RaisedButton(
              ...
              onPressed: () {
                print('web');
                Navigator.of(context).push(
                  CustomRoute(WebPage('webview title',
                      'https://pc87.pechatshop.com/chat/Hotline/channel.jsp?cid=5011033&cnfid=4450&j=8450264871&s=1')),
                );
              },
            ),
            Padding(
